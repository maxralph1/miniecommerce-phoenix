defmodule Miniecommerce.ShoppingCart do
  @moduledoc """
  ...
  alias Miniecommerce.Catalog
  # alias Miniecommerce.ShoppingCart.Cart
  alias Miniecommerce.ShoppingCart.{Cart, CartItem}
  ...
  alias Miniecommerce.ShoppingCart.CartItem
