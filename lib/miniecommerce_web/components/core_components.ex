defmodule MiniecommerceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MiniecommerceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MiniecommerceWeb.Gettext, "errors", msg, opts)
    end
  end
