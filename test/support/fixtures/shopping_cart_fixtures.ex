defmodule Miniecommerce.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Miniecommerce.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> Miniecommerce.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> Miniecommerce.ShoppingCart.create_cart_item()
